...
BUILTIN_SRC = builtin/builtin.c builtin/buildin_utils.c   builtin/chdir.c builtin/env_utils.c builtin/env_utils2.c builtin/env.c builtin/export.c  builtin/get_envp.c builtin/prompt.c builtin/unset.c builtin/ft_strncpy.c builtin/exit.c
